...
function Navbar() {
  return (
    <nav id="navbar" className="Navbar text-white scale-90">
      <img src={voltedgelogo} className="h-20 " alt="" />
      <div className="paratext h-15  w-full border-box px-10 flex justify-between items-center border-[2px] border-white/50 rounded-l-full rounded-r-full transition-all duration-300 hover:shadow-[0px_0px_15px_rgba(255,255,255,0.50)] hover:backdrop-blur-sm hover:bg-black/10 text-[1rem]">
