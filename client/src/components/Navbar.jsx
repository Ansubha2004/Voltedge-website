...
function Navbar() {
  return (
    <div className="Navbar text-white">
      ...
      <div className="paratext h-15 w-full border-box px-10  flex justify-evenly items-center border-[2px] border-white/50 rounded-l-full rounded-r-full transition-all duration-300 hover:shadow-[0px_0px_15px_rgba(255,255,255,0.50)] hover:backdrop-blur-md hover:bg-black/20 ">
