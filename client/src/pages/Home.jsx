  ...
  return (
    <div className="w-screen h-screen relative bg-repeat-no bg-cover bg-center  " style={{ backgroundImage: `url(${background1})` }}>
      <div className="w-screen h-screen absolute bg-black/60 flex flex-col justify-center items-center">
        <p className="float subheading text-white exo-2-font drop-shadow-[0_0_7px_rgba(255,255,255,0.8)] ">Department of EE and EEE, IEM Kolkata presents</p>
        <div className="float sekuya-regular sm:text-[500%] text-[300%] md:text-[700%] text-5xl font-extrabold
