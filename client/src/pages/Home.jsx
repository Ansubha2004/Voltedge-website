...
function Home() {
  ...
  return (
    <div className="w-screen h-screen relative bg-black ">
      <VantaNetBackground />
      <div className="w-fit z-2 whitespace-nowrap h-fit top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 inset-0 absolute flex flex-col gap-5  justify-center items-center">
        ...
        <div className=" flex justify-center items-center text-[1rem] oxanium pop p-2 bg-black/40  border border-white/40 backdrop-blur-sm">
