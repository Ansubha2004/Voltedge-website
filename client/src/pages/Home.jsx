...
function Home() {
  ...
  return (
    <div className="w-screen h-screen relative">
      <VantaNetBackground />
      <div className="scale-95 z-2 whitespace-nowrap h-fit top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 inset-0 absolute flex flex-col gap-5  justify-center items-center">
        <p className="subheading text-white exo-2-font drop-shadow-[0_0_7px_rgba(255,255,255,0.8)] ">EE and EEE Department Presents</p>
        <p className="float sekuya-regular sm:text-[400%] text-[300%] md:text-[500%] leading-none font-extrabold
        ...
        <p className="text-blue-500 translate-y-1 drop-shadow-[1px_1px_0px_rgba(255,255,255,1)] ibm-plex-mono-light">EVENT STARTS IN</p>
        <Timer targetdate="2026-02-27T00:00:00" />
        <div className=" flex justify-center items-center text-[1rem] oxanium pop p-3 bg-black/40 gap-3  border border-white/40 backdrop-blur-sm">
        ...
        <div className=" w-auto h-auto flex justify-center items-center space-x-[10%]">
